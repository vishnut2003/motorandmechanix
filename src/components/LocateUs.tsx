...
const LocateUs = () => {
  const contactLinks = [
    {
      icon: '/wp-content/themes/m%26m/img/mobile-icon.png',
      href: 'tel:083838 38300',
      text: '083838 38300',
      type: 'phone'
    },
    {
      icon: '/wp-content/themes/m%26m/img/whatap-icon.png',
  ...
  return (
    <div className="w-full bg-[#FDD835] py-8 md:py-18">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Section Heading */}
        <h2 className="text-3xl md:text-4xl lg:text-5xl underline font-bold text-center mb-5 md:mb-10">
          Locate Us
        </h2>

        {/* Main Content Container */}
        <div className="bg-white rounded-xl shadow-xl overflow-hidden mb-8 md:mb-12">
            ...
            <div className="p-5 md:p-12 lg:p-16">
              ...
              <div className="flex items-start gap-4 mb-8">
                <div className="flex-shrink-0 flex items-center justify-center">
                  <Image
                    src="/wp-content/themes/m%26m/img/location-icon.png"
                    alt="Location"
                    width={32}
                    height={40}
